...
describe('node-fetch', function() {
	...
	it('should ignore unsupported attributes while reading headers', function() {
		...
		expect(h1.getHeaders['a']).to.include('string');
		expect(h1.getHeaders['b']).to.include('1');
		expect(h1.getHeaders['b']).to.include('2');
		expect(h1.getHeaders['c']).to.include('');
		expect(h1.getHeaders['d']).to.be.undefined;

		expect(h1.getHeaders['e']).to.include('1');
		expect(h1.getHeaders['f']).to.include('1');
		expect(h1.getHeaders['f']).to.include('2');

		expect(h1.getHeaders['g']).to.be.undefined;
		expect(h1.getHeaders['h']).to.be.undefined;
		expect(h1.getHeaders['i']).to.be.undefined;
		expect(h1.getHeaders['j']).to.be.undefined;
		expect(h1.getHeaders['k']).to.be.undefined;
		expect(h1.getHeaders['l']).to.be.undefined;
		expect(h1.getHeaders['m']).to.be.undefined;

		expect(h1.getHeaders['z']).to.be.undefined;
	});
	...
	it('should wrap headers', function() {
		...
		expect(h1.getHeaders['a']).to.include('1');
		expect(h1.getHeaders['a']).to.not.include('2');

		expect(h2.getHeaders['a']).to.include('1');
		expect(h2.getHeaders['a']).to.not.include('2');
		expect(h2.getHeaders['b']).to.include('1');

		expect(h3.getHeaders['a']).to.include('1');
		expect(h3.getHeaders['a']).to.include('2');
		expect(h3.getHeaders['b']).to.include('1');
	});
