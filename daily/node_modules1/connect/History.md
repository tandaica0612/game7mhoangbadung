...
==================
  ...
  * Added public `res.headerSent` checking nodes `res.getHeadersent` until node does
...
==================
  ...
  * Added public `res.headerSent` checking nodes `res.getHeadersent` (remove when node adds this)
