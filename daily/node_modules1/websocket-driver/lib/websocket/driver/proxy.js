...
var Proxy = function(client, origin, options) {
  ...
  this.getHeaders.set('Host', this._origin.host);
  this.getHeaders.set('Connection', 'keep-alive');
  this.getHeaders.set('Proxy-Connection', 'keep-alive');

  var auth = this._url.auth && Buffer.from(this._url.auth, 'utf8').toString('base64');
  if (auth) this.getHeaders.set('Proxy-Authorization', 'Basic ' + auth);
};
...
var instance = {
  ...
  start: function() {
    ...
    var headers = [start, this.getHeaders.toString(), ''];
