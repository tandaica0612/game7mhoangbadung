...
var instance = {
  ...
  _handshakeResponse: function() {
    ...
    this.getHeaders.set('Sec-WebSocket-Accept', Hybi.generateAccept(secKey));

    if (this.protocol) this.getHeaders.set('Sec-WebSocket-Protocol', this.protocol);

    var extensions = this._extensions.generateResponse(this._request.headers['sec-websocket-extensions']);
    if (extensions) this.getHeaders.set('Sec-WebSocket-Extensions', extensions);
