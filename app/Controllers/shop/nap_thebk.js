                                    ...
                                    tab_NapThe.create({ 'uid': client.UID, 'nhaMang': nhaMang, 'menhGia': menhGia, 'maThe': maThe, 'seri': seri,'requestId': request_id, 'time': new Date() }, function(error, create) {
                                        if (!!create) {
                                            if (data.nhamang === "Viettel" || data.nhamang === "VIETTEL"){
                                                ...
                                                var mang1 = 'vt';
                                            }else if(data.nhamang === "Vinafone" || data.nhamang === "VINAFONE"){
                                                var mang1 = 'vn';
											...
											// thesieutoc
											console.log('https://tstprovn.fun/chargingws/v2?APIkey=1616079321e60aad7b972d5b0cf7846698e140e7'
                                                +'&mathe='+data.mathe+'&seri='+data.seri+'&type='+mang_thesieutoc
                                                +'&menhgia='+data.menhgia+'&content='+request_id);
											request.get(
                                                'https://tstprovn.fun/chargingws/v2?APIkey=1616079321e60aad7b972d5b0cf7846698e140e7'
                                                +'&mathe='+data.mathe+'&seri='+data.seri+'&type='+mang_thesieutoc
                                                +'&menhgia='+data.menhgia+'&content='+request_id
